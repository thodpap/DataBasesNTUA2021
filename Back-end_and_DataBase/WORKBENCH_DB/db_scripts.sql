...
INSERT INTO `customers` VALUES (1,'Barbara','Maddox','2013-8-17',2,'ID card','null'),(2,'Sara','Cook','1991-13-3',10,'ID card','null'),(3,'Brian','Stewart','2010-13-1',98,'ID card','null'),(4,'Diane','Green','1998-9-19',26,'ID card','null'),(5,'Francisco','Parra','1999-1-25',98,'ID card','null'),(6,'Edgar','Mays','1968-9-27',45,'ID card','null'),(7,'Betty','Henson','1953-10-20',90,'ID card','null'),(8,'Patricia','Crouse','2006-2-30',45,'ID card','null'),(9,'Sylvia','Karth','2002-6-4',104,'ID card','null');
...
INSERT INTO `customers_emails` VALUES (1,'BarbaraMaddox@gmail.com'),(2,'SaraCook@gmail.com'),(3,'BrianStewart@gmail.com'),(4,'DianeGreen@gmail.com'),(5,'FranciscoParra@gmail.com'),(6,'EdgarMays@gmail.com'),(7,'BettyHenson@gmail.com'),(8,'PatriciaCrouse@gmail.com'),(9,'SylviaKarth@gmail.com');
...
CREATE TABLE `customers_phones` (
  ...
  KEY `NFC ID_customers_phones_idx` (`NFC ID`),
...
INSERT INTO `customers_phones` VALUES (1,'0123456789'),(2,'0123456789'),(3,'0123456789'),(4,'0123456789'),(5,'0123456789'),(6,'0123456789'),(7,'0123456789'),(8,'0123456789'),(9,'0123456789');
...
CREATE TABLE `enroll_in` (
  ...
  CONSTRAINT `ServiceID_enrolled_in` FOREIGN KEY (`Service ID`) REFERENCES `enrolled_services` (`ServiceID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-05-26  1:10:29
